...
from apps.logbook import helpers, views, write
...
urlpatterns = [
    ...
    path("new/backdated/", views.new_backdated, name="new_backdated"),
    ...
    path("api/plates/", helpers.plates, name="plates"),
    path("api/warmups/", helpers.warmups, name="warmups"),
